...
import com.example.dolegal.presentation.screens.home_screen.Leaderboard
        ...
        setContent {
            DoLegalTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    ...
                    if (currentUser) {
                        Navigation(this,LocalContext.current,innerpadding = innerPadding,currentUser = true)
                    } else {
                        Toast.makeText(this, "Please Sign Up", Toast.LENGTH_SHORT).show()
                        Navigation(this,LocalContext.current,innerpadding = innerPadding,currentUser = false)
                    }
